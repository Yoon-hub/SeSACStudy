...
class InViewController: UIViewController {
    ...
    //1. 인앱 상품 ID 정의
    var productIdentifiers: Set<String> = ["com.sesac.SeSAC2Chat22.removeAd"]
    ...
    //2. productIdentifers에 정의된 상품 ID에 대한 정보 가져오기 및 사용자의 디바이스가 인앱결제가 가능한지 여부 확인
    func requsetProductData() {
...
extension InViewController: SKProductsRequestDelegate {
    //3. 인앱 상품 정보 조회
...
extension InViewController: SKPaymentTransactionObserver {
