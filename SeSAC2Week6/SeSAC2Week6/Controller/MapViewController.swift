...
/*
 MapView
 - 지도와 위치 권한은 상관 X
 - 만약 지도에 현재 위치 등을 표현하고 싶다면 위치 권한을 등록 해주어야 한다
 */
...
class MapViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2D(latitude: 35.879916, longitude: 128.628131)
    ...
    func setRegionAndAnnotation(center: CLLocationCoordinate2D) {
        ...
        //지도 중심 기반으로 보여질 범위
        let resign = MKCoordinateRegion(center: center, latitudinalMeters: 1000, longitudinalMeters: 1000)
        mapView.setRegion(resign, animated: true)
